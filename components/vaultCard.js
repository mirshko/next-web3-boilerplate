      ...
      >
        <div style={{ width: 40 }}>
          {isVaultOpen ? (
            ...
            <UpOutlined style={{ fontSize: "12px", color: "#08c" }} />
          )}
        </div>
        <div style={{ width: 300, display: "flex", alignItems: "center" }}>
          <img
            src={"/icons/" + assetNames[0].toLowerCase() + ".svg"}
            width={24}
            height={24}
            alt="token0"
          />
          <img
            src={"/icons/" + assetNames[1].toLowerCase() + ".svg"}
            width={24}
            height={24}
            alt="token1"
          />
        ...
        <div style={{ width: 300, display: "flex", alignItems: "center" }}>
          <img
            src={"/icons/" + vault.network.toLowerCase() + ".svg"}
            width={24}
            height={24}
            alt="network"
          />
        ...
        <div style={{ width: 300 }}>{"TVL: $" + vault.tvl}</div>
        <div style={{ width: 100 }}>
          My Assets: ${parseFloat(availableCollateral).toFixed(0)}
        </div>
      </div>
            ...
            <Card
              title={
                <>
                  ...
                  <Tooltip
                    placement="right"
                    title="Stable performance in any type of market"
                  >
                    <QuestionCircleOutlined />
                  </Tooltip>
                </>
          ...
          <Col span={12} type="flex">
              ...
              title={
                <>
                  <span>
                    ...
                    <Tooltip
                      placement="right"
                      title="Outperforming yield in ranging market conditions"
                    >
                      <QuestionCircleOutlined />
                    </Tooltip>
                  </span>
            ...
            >
              <div style={{ display: "flex", justifyContent: "center" }}>
                45% APR (Uni v3) &rarr; &nbsp; 50% APR (ROE 1x) &rarr; &nbsp;
            ...
            <Card
              ...
              title={
                <>
                  ...
                  <Tooltip
                    placement="right"
                    title="Outperforming in trending markets"
                  >
                    <QuestionCircleOutlined />
                  </Tooltip>
                </>
